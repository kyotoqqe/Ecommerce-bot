...
from tgbot.keyboards.inline.shop_menu import get_shop_menu
...
async def show_shop_menu(message:types.Message):
    await message.answer("Добро пожаловать в меню магазина. Что хотите посетить сегодня ?",reply_markup=get_shop_menu())
